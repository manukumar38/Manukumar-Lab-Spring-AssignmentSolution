...
import com.greatLearning.studentManagement.service.StudentDetailsServiceImpl;

//Set authentication and authorization using spring securtiy
@Configuration
...
//Adding authority for user and admin roles for every API
	@Override
